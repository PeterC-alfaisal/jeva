...
lrm1waovOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "lrm1waovOptions",
...
lrm1waovResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "lrm1waovResults",
    ...
    active = list(
        ...
        conts = function() private$.items[["conts"]],
...
lrm1waovBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "lrm1waovBase",
...
#'   \code{results$conts} \tab \tab \tab \tab \tab a table of the test results \cr
