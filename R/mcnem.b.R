        ...
        .formula=function() {
          ...
          .cleanData = function() {
            ...
            .populateSupportText = function(st) {
              ...
              Sxl = list(s=st$S5)                       
              sv <- private$.strength2(Sxl)
              stg5 <- paste0("For the observed OR", sv, ", that it was more different from the <i>H</i>\u2080 = 1 
                         than expected")
              if (2*st$S5 > st$chi2) {
                stg5 <- paste0("For the observed OR", sv, ", that it was closer to the <i>H</i>\u2080 = 1 than expected")
              }
           ...
           ifelse(Sxl$s > 1.9, paste0("There was moderate evidence, <i>S</i> = ",
            ...
            .populateMoreSupportText = function(st) {
              ...
              str = paste0("<p>The advantage of the evidential approach is that we 
                ...
                the strength of evidence for one hypothesis over the other will tend to increase.</p>")
