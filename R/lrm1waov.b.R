  ...
  table$setRow(rowNo=3, values=list(var='Means'))
    ...
    .populateEffectsTables=function(result) {
      ...
      if ( self$options$ct1 ) {
        ...
        S_c1Nc <- S_c1N + Ac(self$options$correction,np,mp,N)
      }
      ...
      if ( self$options$ct2 ) {      
        ...
        S_c2Nc <- S_c2N  + Ac(self$options$correction,np,mp,N)
      ...
      if ( self$options$ct1 ){
        Parval_c1N <- paste0(c(np, mp), collapse = ', ')
        DFval_c1 <- as.integer(1)
      }

        if ( self$options$ct2 ){        
          Parval_c2N <- paste0(c(np, mp), collapse = ', ')
