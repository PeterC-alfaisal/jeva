...
cttClass <- if (requireNamespace('jmvcore', quietly=TRUE)) R6::R6Class(
    ...
    private = list(
      .init = function() {
        ...
        table$setNote('Note', "The interaction and OR (against 1) will have the same <i>S</i> value. Adding  
    ...
    TRUE
      ...
      .cleanData = function() {
        ...
        .populateSupportText = function(st) {
          ...
          Sxl = list(s=st$S1, "H\u2080", "the observed OR")                       
          stg1 <- private$.strength(Sxl)
          Sxl = list(s=st$S2, "H\u2090", "the observed OR")                       
          ...
          stg8 <- paste0("For the observed OR", sv, ", that it was more different from the H\u2080 = 1 
                         than expected")
          if (2*st$tg > st$chi) {
            stg8 <- paste0("For the observed OR", sv, ", that it was closer to the H\u2080 = 1 than expected")
          }
          
          str = paste0("<br> <h2>Summarizing the evidential analysis</h2>
                               <br>  <i>The main OR analysis shows that:</i> <br>", 
                       ...
                       stg8,
                       "<p>Give the OR and the observed frequencies. The support interval for the OR 
        ...
        .populateMoreSupportText = function(st) {
          ...
          str3 <- "For example, we could choose a meaningful H\u2090 OR to compare with a specified H\u2080 OR 
          (default = 1). This is shown by the last line of the main Support table for OR analyses. "
